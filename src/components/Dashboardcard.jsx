  ...
  return (
    <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-6 mb-6 ">
      <div className="rounded-xl bg-gray-50 p-2 shadow-sm">
        ...
        <p className="bg-white rounded-xl text-center text-2xl px-4 py-8 truncate font-medium">$9,999,999.99</p>
      </div>
      ...
      <div className="rounded-xl bg-gray-50 p-2 shadow-sm">
        ...
        <p className="bg-white rounded-xl text-center text-2xl px-4 py-8 truncate font-medium">1</p>
      </div>
