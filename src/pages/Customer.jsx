              ...
              <div className="overflow-x-auto">
                <table className="hidden min-w-full text-gray-700 md:table font-medium">
                  <thead className="rounded-lg text-left text-sm font-normal ">
                    <tr>
                      <th className="px-4 py-5 font-medium text-base text-gray-900 sm:pl-6">Name</th>
                      <th className="px-4 py-5 font-medium text-base text-gray-900 sm:pl-6">Email</th>
                      <th className="px-4 py-5 font-medium text-base text-gray-900 sm:pl-6">Total Invoice</th>
                      <th className="px-4 py-5 font-medium text-base text-gray-900 sm:pl-6">Total Pending</th>
                      <th className="px-4 py-5 font-medium text-base text-gray-900 sm:pl-6">Total Paid</th>
                    </tr>
                  </thead>
